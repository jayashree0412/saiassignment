...
//Removed the final keyword
    private static  int NUM_MONTHS = 3;
...
//The month variable starts from 1 instead of 0, so this results in printing from Feb instead of Jan, so Iam adding num_months+1
...
//                Here in the month index, I am saying month-1
                days_to_print = month_days[ month-1 ];
// The sequencing was wrong, first the leap year should be checked as it has an extra day, then the month check should be performed and the extra day should only be added for this Feb
